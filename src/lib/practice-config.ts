...
// Personalized for: Optimal Health Solutions
// Generated: Sat Aug  2 18:59:31 CEST 2025
...
export const practiceConfigs: Record<string, PracticeConfig> = {
  'optimal-health-solutions': {
    id: 'optimal-health-solutions',
    name: 'Optimal Health Solutions',
    doctor: 'Dr. David Martinez',
    location: 'Nashville, USA',
    agentId: 'agent_optimal-health-solutions_1754153971',
    type: 'wellness',
    port: 3000,
    subdomain: 'optimal-health-solutions',
    
    chat: {
      assistantName: 'Robin',
      initialMessage: 'Thank you for contacting Optimal Health Solutions! I\'m Robin, your wellness assistant. I can help you schedule appointments with Dr. David Martinez for nutrition therapy treatments. Which service interests you today?',
      systemPrompt: `You are Robin, the scheduling assistant at Optimal Health Solutions in Nashville, USA. Your primary purpose is to help patients schedule appointments with Dr. David Martinez, provide information about nutrition therapy treatments, and answer questions about clinic services.
...
- You work for Optimal Health Solutions, specializing in nutrition therapy
- Dr. David Martinez provides expert care and treatments
- Your main goal is to help patients book appointments and get information about treatments

SERVICES OFFERED:
- nutrition therapy Consultations: Comprehensive health assessments (45-60 minutes)
...
- "For nutrition therapy consultations, I can offer you Tuesday at 2:30pm, Wednesday at 10:00am, or Friday at 4:00pm"
...
- Dr. David Martinez specializes in nutrition therapy
...
- Always confirm important details like dates, times, and treatment types`,
    ...
    voice: {
      firstMessage: 'Thank you for calling Optimal Health Solutions! This is Robin. We\'re here to help you with nutrition therapy care in Nashville, USA. How can I assist you today?',
    },
    
    services: [
      {
        name: 'nutrition therapy Consultation',
    ...
    branding: {
      primaryColor: '#059669',
      tagline: 'Your nutrition therapy Partner',
      focus: 'nutrition therapy care and wellness optimization'
    }
  }
};

// Export default configuration
export const currentPractice = practiceConfigs['optimal-health-solutions'];
